...
for k = 1:size(ant_folder_nums,2)
    ...
    for i = 1:size(interactions,1)
        ...
        for j = 1:size(long_long_interactions)
            ...
            orientation_temp(end+1) = mean(orientations(max(starts-10,1):starts,1),'omitnan');
    ...
    %1. Org
    %2. Approach Speed (-10 frames)
    %3. Flex During (-60 frames)
    %4. Flex After (90 frames)
    %5. Dal Escape Velocity (10 frames)
    %6. Curvature (-90 frames)
    %7. Orientation (10 frames)
    %8. Length 
    %9. Dal Approach Speed (10 frames)
    %10. Other Velocity After (10 frames)
    %11. Other Orientation (10 frames)
