...
% 
% scatter(approach_divs(1:29),danger_percentage_app,60,'filled','k')
% danger_percentage_app(isnan(danger_percentage_app)) = 0;
% 
...
% hold on
% plot(approach_divs(1:29), fit, 'LineWidth' ,2,'Color','black')
% L = legend('',['R^2: ' , num2str(Rsq),newline,], 'Location','northwest', 'FontSize', 15);
% L.AutoUpdate = 'off';
% hold off
% 
...
% 
% hold on
% errorbar(approach_divs(1:29),danger_percentage_app,CI_min,CI_max,'LineStyle','none','Color','red')
% hold off
% 
