...
% subplot(1,2,1)
% plot(orientation_divs(1:19),flex_percentage_ori)
% title('Flex Danger Response (Flex + Both)')
% xlabel('Beetle Orientation')
% ylabel('Percentage of Flex Responses')
% 
% subplot(1,2,2)
% plot(orientation_divs(1:19), flee_percentage_ori)
% title('Flee Danger Response (Flee + Both)')
% xlabel('Beetle Orientation')
% ylabel('Percentage of Flee Responses')
% 
% titles = "Proportion of each Danger Response by Orientation (Ants)"
% sgtitle(titles)

plot(orientation_divs(1:19),danger_percentage_ori)
titles = "Proportion of Responses that are Danger Responses by Orientation (Ants)"
title(titles)

% saveas(gcf,'jasonwong/Projects/neuroetho/Ant Graphs/'+ titles + '.png')